...
class AskEasyAction:
    ...
    def __init__(self):
        rospy.init_node('ask_easy_action_node')
        print("Ask Easy Action Node started!")
    ...
    def _ask_easy_logic(self, action_id, question):
    ...
    def execute(self, question):
        try:
            ...
            while attempt < self.MAX_ATTEMPTS:
                ...
                if not transcript:
                    no_audio_count += 1
                    if no_audio_count >= self.MAX_NO_AUDIO:
                        rospy.logwarn("Troppi tentativi senza audio, esco.")
                        return False
