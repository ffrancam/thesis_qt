...
class ImageEasyAction:
    ...
    QUESTIONS = {
        ...
        'q3':  ("tennis",    "In quale sport si usa questa palla?",             "tennis", "l'immagine mostra una pallina da tennis"),
        'q4':  ("luna",   "Cosa stiamo guardando in questa immagine?",             "la luna", ""),
        'q5':  ("car",      "Che cos'è questa?",                "una macchina", "l'immagine mostra una macchina zoomata"),
        'q6':  ("dinosauro",    "Sai dirmi come si chiama questo animale del passato", "un dinosauro/t-rex/tirannosauro", ""),
        ...
        'q10': ("tucano",      "Sai dirmi che animale è questo?",    "un tucano", "l'immagine mostra un tucano")
    }

    MAX_ATTEMPTS = 2

    def __init__(self):
        rospy.init_node('image_easy_action_node')
        print("Image Easy Action Node started!")
        ...
        print("Image Easy Action Interface ready!")
        rospy.spin()
    ...
    def _image_easy_logic(self, action_id, image):
    ...
    def execute(self, image):
        try:
            ...
            while attempt < self.MAX_ATTEMPTS:
                ...
                # rospy.sleep(0.5)  # piccola pausa prima di ascoltare
                self.qt.show_image(filename + "_icon")  # icona "robot sta ascoltando"
