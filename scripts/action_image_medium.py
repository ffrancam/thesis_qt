...
class ImageMediumAction:
    ...
    QUESTIONS = {
        ...
        'q5':  ("elicottero",      "Che mezzo di trasporto è questo?",    "un elicottero", "l'immagine mostra la silhouette di un elicottero"),
        'q6':  ("igloo",    "Come si chiama questa abitazione ghiacciata?", "igloo", ""),
        'q7':  ("kiwi",      "Sai dirmi che frutto è questo?",    "un kiwi", ""),
        'q8':  ("lava",      "Cos'è questo liquido rosso?",    "lava/magma", ""),
        'q9':  ("life_jacket",      "Guarda la foto. Perché bisogna indossare questo oggetto quando si va in barca?",    "per non affogare / per galleggiare se si cade / per salvarsi", "l'immagine mostra un giubbotto di salvataggio"),
        'q10': ("rugiada",      "Cosa sono le goccioline d'acqua che vedi?",    "rugiada", ""),
        'q11': ("terra",      "Sai dirmi cos'è questa?",    "la Terra", ""),
    }

    MAX_ATTEMPTS = 2

    def __init__(self):
        rospy.init_node('image_medium_action_node')
        print("Image Medium Action Node started!")
        ...
        print("Image Medium Action Interface ready!")
        rospy.spin()
    ...
    def action_callback(self, msg):
        ...
        threading.Thread(
            target=self._image_medium_logic,
    ...
    def _image_medium_logic(self, action_id, image):
