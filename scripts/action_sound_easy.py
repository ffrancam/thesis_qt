...
class SoundEasyAction:
    ...
    QUESTIONS = {
        ...
        'q7':  ("QT/sound_easy/baby_crying",    "Cosa sta succedendo?", "un bambino sta piangendo / un neonato sta piangendo"),
        'q8':  ("QT/sound_easy/donkey",   "Ascolta questo verso strano. Che animale è?", "un asino / un somaro"),
        'q9':  ("QT/sound_easy/drum",    "Che strumento musicale è?",        "la batteria / un tamburo"),
        'q10': ("QT/sound_easy/monkey", "Ascolta questo verso agitato. Chi sta facendo questo rumore?", "una scimmia"),
        'q11': ("QT/sound_easy/school_bell",  "Dove puoi sentire questo suono quando finisce una lezione?", "a scuola / è la campanella della scuola"),
    }

    MAX_ATTEMPTS = 2

    def __init__(self):
        rospy.init_node('sound_easy_action_node')
        print("Sound Easy Action Node started!")
        ...
        print("Sound Easy Action Interface ready!")
        rospy.spin()
    ...
    def _sound_easy_logic(self, action_id, sound):
